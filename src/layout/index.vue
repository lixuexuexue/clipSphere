...
<template>
  <div class="h-full  transition-all p-0 ">
    <div class="h-full overflow-hidden">
      <Header />
      <div class="z-40 transition flex  h-full relative dark:bg-[#000] bg-[#dce3f1]" :class="getMobileLayoutClass">
        <SiderBar v-if="!isMobile" />
        <NLayoutContent class="h-full rounded-md" style="flex: 1" :class="getMobileMainClass">
