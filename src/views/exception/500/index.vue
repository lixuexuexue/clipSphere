...
<template>
  <div class=" welcome flex h-full dark:bg-neutral-800">
        ...
        <svg id="store" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="130 0 1230 930">
          ...
          <defs>
            ...
            <g id="tree">
              ...
              <g opacity="0.4">
                <path fill=" #7869f5" d="M1085.2 552.4c-29.4 14.7-49.5 45-49.5 80.1 0 49.4 40.1 89.5 89.5 89.5 49.4 0 89.5-40.1 89.5-89.5 0-35.2-20.3-65.6-49.8-80.2" />
                <path fill=" #7869f5" d="M1164.9 552.3c10-10.1 16.1-24 16.1-39.3 0-30.9-25.1-56-56-56s-56 25.1-56 56c0 15.4 6.2 29.3 16.2 39.4" />
                <path fill=" #7869f5" d="M1153.9 561c4-2.4 7.7-5.4 11-8.7" />
                <path fill=" #7869f5" d="M1104.3 545.5c-6.7 1.6-13.1 3.9-19.1 7" />
              </g>
            ...
            <g id="cat">
              <circle fill=" #7869f5" cx="1115" cy="625" r="25" />
              <path fill="#FFF" stroke=" #7869f5" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M1097.1 612.3c0 0-4.5-9.3-0.3-17.7 0 0 4.5 5.6 9.3 7" />
              <path fill="#FFF" stroke=" #7869f5" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M1140.6 612.3c0 0 4.5-9.3 0.3-17.7 0 0-4.5 5.6-9.3 7" />
              <circle fill="#FFF" stroke=" #7869f5" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" cx="1118.6" cy="621.7" r="23.1" />
              <path fill="#ED4F43" d="M1122.4 625c0 5.3-1.4 6.3-3.8 6.3 -2.4 0-3.8-1-3.8-6.3" />
              <path fill="#FFF" stroke=" #7869f5" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M1132.8 621.2c0 3.9-3.2 7-7 7s-7-3.2-7-7h-0.2c0 3.9-3.2 7-7 7s-7-3.2-7-7" />
              <path fill="#FFF" stroke=" #7869f5" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M1104.7 613c0 0 0-3.1 2.8-3.8 2.9-0.8 4.2 1.7 4.2 1.7" />
              <path fill="#FFF" stroke=" #7869f5" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M1132.6 613c0 0 0-3.1-2.8-3.8 -2.9-0.8-4.2 1.7-4.2 1.7" />
              <path fill=" #7869f5" d="M1118.6 622c0 0-2.9-0.8-2.9-1.9v0c0-1 0.8-1.9 1.9-1.9h2.2c1 0 1.9 0.8 1.9 1.9v0C1121.6 621.2 1118.6 622 1118.6 622z" />
            </g>
            <g id="parachute">
            ...
            <g id="box">
              ...
              <polygon opacity="0.4" fill=" #7869f5" points="394.1 47 394.5 81.5 408.5 70.5 422.5 81.5 422.5 47 463.3 31 431.7 31 " />
            ...
            <g id="cap">
              ...
              <ellipse fill=" #7869f5" cx="445.9" cy="763.4" rx="8.5" ry="3" />
              ...
              <circle fill=" #7869f5" cx="429.4" cy="777.4" r="2" />
              <circle fill=" #7869f5" cx="462.4" cy="777.4" r="2" />
            </g>
            <g id="ball">
            ...
            <g id="plane">
              ...
              <g id="helix">
                <path fill=" #7869f5" d="M1037.8 233.5h-1.8c-4.2 0-3.1-12.1-3.1-12.1s-1.1-12.1 3.1-12.1l0 0c5.2 0 9.4 4.2 9.4 9.4v7.2C1045.4 230.1 1041.9 233.5 1037.8 233.5z" />
              ...
              <use class="helix" xlink:href="#helix" filter="url(#f1)" />
              ...
              <text transform="matrix(1.0027 0 0 1 44.8218 224.8768)" font-family="Fredoka One" font-size="34" fill=" #7869f5"> 出了点小错误、刷新看看呢...... </text>
          ...
          <g id="window">
            <path opacity="0.4" fill=" #7869f5" d="M683.6 773H368c-8.1 0-14.7-6.6-14.7-14.7V565.2c0-8.1 6.6-14.7 14.7-14.7h315.6c8.1 0 14.7 6.6 14.7 14.7v193.1C698.3 766.4 691.7 773 683.6 773z" />
          ...
          <use class="box" xlink:href="#box" x="20" y="30" />
          <use class="parachute" xlink:href="#parachute" x="20" y="-112" />
          <rect fill="white" x="320" y="310" width="665" height="238" />
          <use class="tshirt" xlink:href="#tshirt" />
          <use class="cap" xlink:href="#cap" y="-150" />
          <use class="ball" xlink:href="#ball" y="-140" />
          <use class="sky-circle" xlink:href="#sky-circle" x="-10px" y="5" />
          <use class="sky-circle2" xlink:href="#sky-circle" x="500px" y="-125" />
          <use class="sky-circle3" xlink:href="#sky-circle" x="1000px" y="50" />
          <use class="cloud" xlink:href="#cloud2" x="0" y="10" />
          <use class="plane" xlink:href="#plane" y="-80" />

          <use class="cloud2" xlink:href="#cloud" x="0" y="130" />
          <use class="trees" xlink:href="#tree" x="40" y="0" />
          <circle class="cat-shadow" fill=" #7869f5" cx="1160" cy="620" r="23" />
          <use class="cat" xlink:href="#cat" x="15" y="5" />
          <g id="browser">
            ...
            <path fill="none" stroke=" #7869f5" class="stroke" d="M943.5 361.5H454.1c-5.5 0-9.9-4.5-9.9-9.9V344c0-5.5 4.5-9.9 9.9-9.9h489.4c5.5 0 9.9 4.5 9.9 9.9v7.6C953.4 357.1 949 361.5 943.5 361.5z" />
          ...
          <g id="toldo">
            ...
            <use class="tol" xlink:href="#tol" x="-250" />
            <use class="tol" xlink:href="#tol" x="334" />
            <use class="tol" xlink:href="#tol" x="417" />
            ...
            <path opacity="0.4" fill=" #7869f5" d="M467.3 392.1h73.4l-14 79.5c0 22.7-18.4 41-41 41 -22.7 0-41-18.4-41-41L467.3 392.1z" />
            <path opacity="0.4" fill=" #7869f5" d="M615.7 392.1H690l3.5 79.5c0 22.7-18.4 41-41 41 -22.7 0-41-18.4-41-41L615.7 392.1z" />
            <path opacity="0.4" fill=" #7869f5" d="M765.1 392.1h73.4l21.8 79.5c0 22.7-18.4 41-41 41s-41-18.4-41-41L765.1 392.1z" />
            <path opacity="0.4" fill=" #7869f5" d="M913.6 392.1h73.4l40.2 79.5c0 22.7-18.4 41-41 41 -22.7 0-41-18.4-41-41L913.6 392.1z" />
            <path opacity="0.4" fill=" #7869f5" d="M317.9 392.1h73.4l-31.4 79.5c0 22.7-18.4 41-41 41 -22.7 0-41-18.4-41-41L317.9 392.1z" />
          ...
          <g id="door">
            ...
            <rect fill=" #7869f5" x="730" y="700" width="225" height="15" />
            <g id="sign">
              ...
              <text class="btn" transform="matrix(1.0027 0 0 1 789.6294 721.7501)" fill="#FFF" font-family="Fredoka One" font-size="38" @click="toHome"> HOME </text>
          ...
          <g id="button">
            <path opacity="0.4" fill=" #7869f5" d="M650.5 725.5H547.8c-4.7 0-8.6-3.9-8.6-8.6v-18.1c0-4.7 3.9-8.6 8.6-8.6h102.7c4.7 0 8.6 3.9 8.6 8.6v18.1C659.2 721.7 655.3 725.5 650.5 725.5z" />
          ...
          <use class="grass" xlink:href="#grass" x="130" y="0" />
          <rect class="grass" x="130" y="850" fill="#a5c7e4" width="100%" height="80" />
        </svg>
      </div>
    </div>
  </div>
...
.border-animation:after {
  content: "";
  background: linear-gradient(45deg, #ccc 48.9%, #917ef1 49%);
...
.cloud2 {
  animation: clouds 20s 25s linear backwards infinite;
}
.plane {
